      ...
      <div className="item max-w-[1400px] mx-auto bg-white dark:bg-black rounded-[20px] flex flex-col">
        ...
        <main className="w-full pt-[100px] pb-16">
          ...
          <section className="bg-white dark:bg-[#121212] text-gray-900 dark:text-white py-12 md:py-20 px-4 md:px-20 mt-8 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <img
                ...
                alt="Burger"
                className="rounded-[16px] w-full h-[350px] object-cover"
              />
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="border border-gray-300 dark:border-gray-700 p-4 rounded">
                    <h3 className="text-xl font-semibold mb-1">Online Food Delivery</h3>
                  ...
                  <div className="border border-gray-300 dark:border-gray-700 p-4 rounded">
                    <h3 className="text-xl font-semibold mb-1">Authentic Food</h3>
                    <p className="text-gray-600 dark:text-gray-400">
          ...
          <section className="mt-12 px-4 md:px-10">
            ...
            <HorizontalScroll>
              <MenuCard
                img="https://www.shutterstock.com/image-photo/double-chicken-burger-isolated-on-600nw-1923966728.jpg"
                title="Classic Chicken"
                desc="Ricotta/goat cheese/beetroot"
                price="$35"
              />
              <MenuCard
                img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRi2cvYFW-XJki_OTmIztEk0I-iy4zlJJKIkw&s"
                title="Cheese Burger"
                desc="Atlantic/chips/salad"
                price="$42"
              />
              <MenuCard
                img="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSk3TBX_bxY9jwlxgvsEMEKTj_b8PMLAFoaGw&s"
                title="Pepperoni Pizza"
                desc="Ricotta/goat cheese/beetroot"
                price="$29"
              />
              <MenuCard
                img="https://img.freepik.com/premium-photo/italian-pizza-margherita-black-background_356194-1114.jpg"
                title="Margherita Pizza"
                desc="Tartare/chips/salad"
                price="$15"
              />
            </HorizontalScroll>
            ...
            <HorizontalScroll>
              <MenuCard
                img="https://img.freepik.com/free-photo/pre-prepared-food-showcasing-ready-eat-delicious-meals-go_23-2151246066.jpg"
                title="Classic Chicken"
                desc="Ricotta/goat cheese/beetroot"
                price="$35"
              />
              <MenuCard
                img="https://media.istockphoto.com/id/521403691/photo/hot-homemade-pepperoni-pizza.jpg?s=612x612&w=0&k=20&c=PaISuuHcJWTEVoDKNnxaHy7L2BTUkyYZ06hYgzXmTbo="
                title="Cheese Pizza"
                desc="Tartare/chips/salad"
                price="$42"
              />
              <MenuCard
                img="https://thumbs.dreamstime.com/b/grill-chicken-legs-grilled-chicken-legs-bbq-sesame-parsley-tomato-95526623.jpg"
                title="Grilled Chicken"
                desc="Atlantic/salad/tartare"
                price="$29"
              />
              <MenuCard
                img="https://media.istockphoto.com/id/1340589333/photo/homemade-indian-chicken-tikka-masala-pizza.jpg?s=612x612&w=0&k=20&c=QetWD3UJeCFoTq6OYNJehauw7Utc8MxH6B90Cb9zvLw="
                title="Tikka Masala Pizza"
                desc="Cheesy/spicy marinade"
                price="$15"
              />
            </HorizontalScroll>
          </section>
          ...
          <section className="mt-12 px-4 md:px-10">
            <div className="relative rounded-lg overflow-hidden">
              ...
              <div className="absolute left-6 md:left-20 bottom-8 md:bottom-16 text-white max-w-lg">
                ...
                <button className="mt-4 bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3 rounded-full">
                  Accept This Deal
                </button>
              </div>
            </div>
...
function SpecialCard({ img, title }) {
  return (
    <div className="text-center bg-gray-100 dark:bg-[#0b0b0b] rounded-2xl p-4">
      <img src={img} alt={title} className="rounded-xl w-full h-[220px] object-cover" />
      <p className="mt-3 text-gray-900 dark:text-white font-semibold text-lg">{title}</p>
...
function MenuCard({ img, title, desc, price }) {
  return (
    <div className="min-w-[250px] bg-gray-100 dark:bg-[#111] rounded-2xl p-4 text-center hover:scale-105 transition flex-shrink-0">
      <img src={img} alt={title} className="w-52 h-44 mx-auto mb-4 rounded-xl object-cover" />
      <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{title}</h3>
      <p className="text-gray-600 dark:text-gray-400 text-sm mt-2">{desc}</p>
      <div className="mt-3 flex items-center justify-center gap-4">
        <span className="inline-block mt-3 text-xs bg-red-500 px-3 py-1 rounded-full text-white">{price}</span>
